create table tb_user(
  ...
  `version` int unsigned not null default 0 comment '当前用户信息版本',
  primary key (`id`)
)comment '用户表';
...
create table tb_user_snapshot(
  ...
  `name` varchar(45) not null default '' comment '用户名',
  `age`  tinyint unsigned not null default 0 comment '年龄',
  `version` int unsigned not null default 0 comment '用户信息版本',
...
create table tb_good(
  ...
  `update_at` datetime not null default current_timestamp comment '更新时间',
  `version` int unsigned not null default 0 comment '当前商品信息版本',
  primary key (`id`)
)comment '商品表';
...
create table tb_good_snapshot(
  ...
  `category_id`  int unsigned not null default 0 comment '品类ID',
  `price`  int unsigned not null default 0 comment '价格（分）',    
  `version` int unsigned not null default 0 comment '商品信息版本',
  `snapshot_at` datetime not null default current_timestamp comment '快照生成时间',
  primary key (`id`),
...
create table tb_good_detail_snapshot(
  `id` int unsigned not null auto_increment comment 'id',
  `good_snapshot_id` int unsigned not null comment '商品快照表id',
...
create table tb_order(
  ...
  `user_id` int unsigned not null comment '用户id',
  `user_snapshot_id` int unsigned not null comment '用户快照id',
  `good_id` int unsigned not null comment '商品id',
  `good_snapshot_id` int unsigned not null comment '商品快照id',  
